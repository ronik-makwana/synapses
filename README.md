...
- **AI/Embeddings:** LangChain.js, Google Gemini
...
```sh
git clone https://github.com/ronik-makwana/synapses.git
cd synapses
```
...
2. **Set up environment variables:**
    ```sh
    cp .env.example .env   # then edit SECRET_KEY, GOOGLE_API_KEY, PINECONE_* etc.
    ```
